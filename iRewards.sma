...
public plugin_init()
{
	...
	register_clcmd("say /get", "get_free_point")
...
public get_free_point(id)
{
	new random_points = random_num(0, 100)
	set_user_point(id, get_user_point(id) + 10 ) 
	
	client_print(id, print_center, "[%s] you have got a random %d point as reward, and your total now is %d", TAG, random_points, g_iPoints[id] )
}
public main_menu(id)
{
...
/* Stopped right here to finish later */
